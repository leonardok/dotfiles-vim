" Vim color file
" Name:       leoc.vim
" Maintainer: Leonardo Korndorfer <leokorndorfer@gmail.com>
"
" Based on:
" Name:       inkpot.vim
...
if has("gui_running")
    ...
    hi LineNr         gui=NONE   guifg=#8b8bcd ctermfg=241 guibg=#2e2e2e
    ...
    exec "hi CursorLine     cterm=NONE   ctermfg=NONE ctermbg=237"
    ...
    exec "hi VertSplit      cterm=NONE   ctermfg=255 ctermbg=0"
    ...
    exec "hi LineNr         cterm=NONE   ctermfg=241 ctermbg=0"
    ...
    exec "hi Keyword        cterm=BOLD   ctermfg=173 ctermbg=NONE"
    exec "hi Comment        cterm=NONE   ctermfg=95 ctermbg=NONE"
    exec "hi Constant       cterm=NONE   ctermfg=74 ctermbg=NONE"
    exec "hi String         cterm=NONE   ctermfg=107 ctermbg=NONE"
    ...
    exec "hi PreProc        cterm=BOLD   ctermfg=25 ctermbg=" . "NONE"
    exec "hi Special        cterm=NONE   ctermfg=164 ctermbg=" . "NONE"
    exec "hi SpecialChar    cterm=BOLD   ctermfg=160 ctermbg=NONE"
    exec "hi Statement      cterm=BOLD   ctermfg=166 ctermbg=" . "NONE"
    exec "hi Todo           cterm=BOLD   ctermfg=" . <SID>X(16) . " ctermbg=" . <SID>X(57)
    exec "hi Type           cterm=BOLD   ctermfg=167 ctermbg=NONE"
